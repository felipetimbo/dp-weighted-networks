                ...
                for optin_perc in self.optins_perc:
                    ...
                    for e in self.es:
                        ...
                        for r in range(self.runs):
                            ...
                            top_m_edges_w_noisy, num_remaining_edges = tools.high_pass_filter(edges_w_noisy, e1, len_all_edges_without_in_in)
                            ...
                            new_g = tools.sample_graph(g, edges_w_noisy_non_zero, edges_w_noisy_zeros, with_ns_property=True)
                            print(1)
