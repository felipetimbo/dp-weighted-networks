            ...
            for optin_method in self.optins_methods: 
                for optin_perc in self.optins_perc:
                    ...
                    for e in self.es:
                        ...
                        e2 = 0.45*e # budget for query degree sequence
                        ...
                        for r in range(self.runs):
                            ...
                            g_priority_sampled = tools.build_g_from_edges(g, all_edges_after_ps, add_optin_edges=False)
                            ...
                            path_graph = "./data/%s/exp/graph_perturbed_%s_ins%s_e%s_r%s_global_ps1.graphml" % ( dataset , optin_method, optin_perc, e, r)     
