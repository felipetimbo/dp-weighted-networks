                ...
                for optin_perc in self.optins_perc:
                    ...
                    for e in self.es:
                        ...
                        for r in range(self.runs):    
                            path_g1 = os.path.abspath(os.path.join(os.path.dirname( __file__ ), 'data', dataset, 'exp', 'graph_perturbed_%s_ins%s_e%s_r%s_global_ds_ns.graphml' % ( optin_method, optin_perc, e, r )))
                            g1 = WGraph(path_g1)
                    ...
                    path_result = "./data/%s/results/ego_metrics_%s_%s.csv" % ( dataset, optin_method, optin_perc) 
