            ...
            for optin_method in self.optins_methods: 
                for optin_perc in self.optins_perc:
                    ...
                    for e in self.es:
                            ...
                            for ego_metr in self.ego_metrics:
                                ...
                                for error_metr in self.error_met: 
                                    if ego_metr == 'edges_w':
                                        ...
                                        # error_4 = error_metrics.calculate_error_edges_w( error_metr, ego_metrics_true[ego_metr], ego_metric_pred_4)                   
                        ...
                        for ego_metr in self.ego_metrics:
                            for error_metr in self.error_met:
                                ...
                                errors_1[ego_metr][error_metr].append(float("{:.2f}".format(ego_metric_mean_1)) )

                                ego_metric_mean_2 = np.mean( errors_list_2[ego_metr][error_metr] )
                                errors_2[ego_metr][error_metr].append(float("{:.2f}".format(ego_metric_mean_2))  )

                                ego_metric_mean_3 = np.mean( errors_list_3[ego_metr][error_metr] )
                                errors_3[ego_metr][error_metr].append(float("{:.2f}".format(ego_metric_mean_3)) ) 

                                # ego_metric_mean_4 = np.mean( errors_list_4[ego_metr][error_metr] )
                                # errors_4[ego_metr][error_metr].append(float("{:.2f}".format(ego_metric_mean_4))  )
                    ...
                    for ego_metr in self.ego_metrics:
                        ...
                        values_concatenated[ego_metr] = v123
                    ...
                    path_result = "./data/%s/results/%s_ego_metrics_%s_%s.csv" % ( dataset, error_metr, optin_method, optin_perc) 
